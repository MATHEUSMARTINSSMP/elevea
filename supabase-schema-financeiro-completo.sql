...
-- VERSÃO COMPLETA COM site_slug PARA MULTITENANCY
-- ============================================================
...
DO $$ 
BEGIN
  -- Adicionar site_slug nas tabelas se não existir
...
-- Triggers para auto-popular site_slug (se não fornecido)
...
-- Triggers para auto-popular site_slug
...
-- Categorias DRE padrão (sem site_slug para serem globais ou com site_slug específico)
-- Estas podem ser criadas por cliente via n8n
